...
import ProductCardLoadingGrid from "./ProductCardLoadingGrid";
import CategoryLoadingBar from "@/app/components/SortAndSearchBar/CategoryLoadingBar";
import SortAndSearchBarLoading from "@/app/components/SortAndSearchBar/SortAndSearchBarLoading";

const ProductAchieveLoading = ({
  pageTitle,
  hideCategory = false,
}: {
  pageTitle: string;
...
export default ProductAchieveLoading;
