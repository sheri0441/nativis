...
const WhySectionCard = ({
  ...
  return (
    <div
      className={`w-fit mx-auto  sm:grid-cols-2 items-center max-w-[880px] mt-3 sm:mt-10 transition-opacity duration-500 ease-in-out hidden ${
        isActive && "block sm:grid"
      }
      `}
    >
